...
//***************************** Is Display Methods **********************************************//
    ...
    public List<Double> afterFilterPrice(By element) {
        //Store elements after filtering
        List<WebElement> afterFilterProductPrice = getMultipleElements(element);
    ...
    public List<Double> convertPriceListToReverse(By element) {
        List<WebElement> beforeFilterProductPrice = getMultipleElements(element);
